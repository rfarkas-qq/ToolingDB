...
This application will provide clean, intuitive, and reliable interface for managing the location, status, and parameters of all core production assets.

**Core Assets to Track:**
* **Tools:** The primary tools used to create parts from foam.
